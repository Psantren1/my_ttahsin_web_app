  ...
  return (
    <>
      ...
      <div className="bg-amber-50 rounded-2xl border border-amber-100 p-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-bold text-amber-800">Sertifikat Tahsin Al-Quran</p>
          <p className="text-xs text-amber-600 mt-0.5">
            Sertifikat akan muncul di sini setelah diterbitkan oleh Admin.
            Hubungi Guru Anda untuk informasi lebih lanjut.
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-3xl border border-tosca-50 shadow-sm p-12 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-slate-400 font-semibold max-w-xs">
                Sertifikat Anda belum diterbitkan. Selesaikan setoran Tahsin dan hubungi Guru untuk proses kelulusan.
              </p>
            </div>
                  ...
                  <div className="flex items-start justify-between relative z-10">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-widest text-tosca-300">
                          Sertifikat Resmi
                        </span>
                      </div>
                      <p className="text-base font-black text-white">{srt.santriName}</p>
                      <p className="text-[10px] text-tosca-300 font-semibold">No. {srt.nomorSertifikat}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-[9px] text-tosca-300 font-bold uppercase">Diterbitkan</p>
                  ...
                  <div className="bg-slate-50 rounded-2xl border border-slate-100 p-3">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {[
                        ...
                        >
                          <p className={`text-[8px] font-bold uppercase ${item.highlight ? 'text-tosca-200' : 'text-slate-400'}`}>
                            {item.label}
                          </p>
